...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoicm9kcmlnb2JhbGl6YSIsImEiOiJja2h2YXQwODcxM3QxMnVwZzF6dHEyZXFnIn0.3G-BCS3Gm-spqC_uq8c6Yw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/rodrigobaliza/ckhvc2v2b021i1ao1o1msfneh',
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (response.data.status === 'success') {
              (0, _alert.showAlert)('success', 'account updated in successfully!');
            }
...
if (bookButton) {
  bookButton.addEventListener('click', function (event) {
    ...
    event.target.textContent = 'Processing...'; //const tourId = event.target.dataset.tourId;

    var tourId = event.target.dataset.tourId; //mesma coisa que na linha de cima mas mais moderno ES6...
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateAccount.updateAccount)(form, 'data');
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(event) {
      var password, passwordNew, passwordConfirm, data;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 7;
              return (0, _updateAccount.updateAccount)(data, 'password');
